...
int main()
{
    ...
    std::vector<std::vector<float>> testingData = parsedCsv;
    int testparam = 0;
    int n_tests = 2;
    float scores[parsedCsv.size()] = {0};
    ofstream fw("C:\\Users\\anton\\OneDrive\\Skrivbord\\Thesis_Code\\IsolationForestTinyML\\DatSets\\mondrian_scores_pima.txt", std::ofstream::out);
